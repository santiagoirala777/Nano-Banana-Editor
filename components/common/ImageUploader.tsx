...
export const ImageUploader: React.FC<ImageUploaderProps> = ({ label, description, imageSrc, onImageUpload, onImageRemove }) => {
  ...
  return (
    <div>
      ...
      <div
        className="relative w-full aspect-square bg-gray-700 rounded-md border-2 border-dashed border-gray-600 flex items-center justify-center cursor-pointer hover:border-indigo-500 transition-colors"
